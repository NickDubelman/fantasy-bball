...
type User struct {
	...
	// LastActive holds the value of the "lastActive" field.
...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldPicture:
			values[i] = &sql.NullString{}
		case user.FieldJoined, user.FieldLastActive:
...
func (u *User) assignValues(columns []string, values []interface{}) error {
	...
	for i := range columns {
		...
		case user.FieldLastActive:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field lastActive", values[i])
			} else if value.Valid {
...
func (u *User) String() string {
	...
	builder.WriteString(", lastActive=")
