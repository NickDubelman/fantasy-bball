...
// LastActive applies equality check predicate on the "lastActive" field. It's identical to LastActiveEQ.
...
// JoinedIsNil applies the IsNil predicate on the "joined" field.
...
// JoinedNotNil applies the NotNil predicate on the "joined" field.
...
// LastActiveEQ applies the EQ predicate on the "lastActive" field.
...
// LastActiveNEQ applies the NEQ predicate on the "lastActive" field.
...
// LastActiveIn applies the In predicate on the "lastActive" field.
...
// LastActiveNotIn applies the NotIn predicate on the "lastActive" field.
...
// LastActiveGT applies the GT predicate on the "lastActive" field.
...
// LastActiveGTE applies the GTE predicate on the "lastActive" field.
...
// LastActiveLT applies the LT predicate on the "lastActive" field.
...
// LastActiveLTE applies the LTE predicate on the "lastActive" field.
...
// LastActiveIsNil applies the IsNil predicate on the "lastActive" field.
func LastActiveIsNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldLastActive)))
	})
}

// LastActiveNotNil applies the NotNil predicate on the "lastActive" field.
func LastActiveNotNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
